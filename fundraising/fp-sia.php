...
$fundraising_name = "FUNDRAISING FOR SIA THE CAT";
...
error_log("Total Raised for Sia: " . $data['total_raised']);
error_log("Donor Count for Sia: " . $data['donor_count']);

// Ensure default values
$totalRaised = $data['total_raised'] ?? 0;
$donorCount = $data['donor_count'] ?? 0;
$goalAmount = 7000; // Goal for Sia's fundraiser
...
<head>
    ...
    <title> SWS - Fundraising for Sia </title>
...
<body>
    ...
    <div class="main-column">
        <section class="fundraising-header">
            <h2 class="fundraising-title"> FUNDRAISING FOR SIA, THE CAT </h2>
        </section>
            ...
            <div class="image-donation-cont">
                <div class="images-container">
                    <video class="main-image" controls autoplay muted>
                        <source src="../media/SIA.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <div class="thumbnails">
                        <img src="../media/fp-sia1.jpg" />
                        <img src="../media/fp-sia2.jpg" />
                        <img src="../media/fp-sia3.jpg" />
                    </div>
                </div>
            ...
            <div id="fundraising-donation-modal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="fundraising-donation-form" enctype="multipart/form-data">
                        <input type="hidden" id="fundraising-name" name="fundraising-name" value="FUNDRAISING FOR SIA THE CAT">
            ...
            <div class="campaign-deets-section">
                <section class="campaign-details">
                    ...
                    <p class="about-details">
                        It was fellow advocate Ronald de Castro who messaged SWS for help with this poor Siamese cat I named Sia.
                        According to him, the cat suddenly entered a garage, looking sick, having a hard time breathing, and walking like drunk.
                        The one who owns the home tried to feed the cat then messaged Ronald. <br> </p>
                    <p class="petnamestory-label"> Sia's Story </p>
                    <p class="petname-story">
                        Sympathetic, SWS rescued Sia and brought her to Vetlink Vet Clinic for her much needed tests and treatment.
                        She was negative for the panleukopenia virus, thankfully but as the vets said and worried about, Sia’s nasal discharge is severe
                        and she is badly dehydrated. Her stool is wet and she was tested positive for protozoal infection. <br> <br>
                        X-ray showed spots in her lungs, indicated of respiratory infection. She has an enlarged stomach possibly due to gas
                        and she is suspected of having Gastric Dilatation and Volvulus. Her CBC and blood chem test results are as follows: <br> <br>
                        “Cbc - mataas po ang infection. Thrombocytopenia noted rin po. Possible ang taas ng wbc count due to the respiratory infection
                        as well as sa kanyang stomach; Biochemistry - high total protein and globulin due to inflammation and infection.
                        High glucose and cholesterol pwede dala na rin po ng stress. High total bilirubin noted rin po.” <br> <br>
                        Sia is considered to be in critical condition. She is now on intensive care and meds. She is nebulized regularly and on
                        syringe feeding. Please pray for her survival. May she be able to fight her illnesses and be given a chance at a better life. <br> <br>
                        We again need to ask for your assistance, as funds are depleted. We hope you can send your donations for Sia’s treatment.
    ...
    thumbnails.forEach((thumbnail) => {
        thumbnail.addEventListener('click', () => {
            ...
            if (thumbnail.tagName === 'VIDEO') {
                ...
                mainVideo.type = 'video/mp4';
                mainVideo.play();
            } else {
                mainVideo.src = thumbnailSrc;
                mainVideo.type = 'image/jpeg';
            }

            thumbnail.src = mainVideoSrc;
        });
    });
</script>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        function fetchUpdatedDonations() {
            ...
            console.log("Fetching donation data for:", fundraisingName); // Debugging
